...
import type { CreateJobData, CreateJobResponse, MyJobsResponse, SingleJobResponse, UpdateJobResponse,} from './jobTypes'
...
const updateJob = async (id: number, data: CreateJobData,): Promise<UpdateJobResponse> =>
{
